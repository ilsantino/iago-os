...
| # | Skill Name | Source Repo | Source Path | What It Does (1 sentence) | Triggering Conditions | Line Count | Dependencies |
|---|-----------|-------------|-------------|--------------------------|----------------------|------------|-------------|
| 48 | article-writing | ECC | `skills/article-writing/SKILL.md` | Structured article/blog post creation workflow | Not specified | — | None |
| 49 | content-engine | ECC | `skills/content-engine/SKILL.md` | Content pipeline for multi-format output | Not specified | — | None |
| 50 | investor-materials | ECC | `skills/investor-materials/SKILL.md` | Create investor decks, one-pagers, and pitch materials | Not specified | — | None |
| 51 | investor-outreach | ECC | `skills/investor-outreach/SKILL.md` | Investor communication and outreach workflows | Not specified | — | None |
| 52 | market-research | ECC | `skills/market-research/SKILL.md` | Market analysis and competitive research | Not specified | — | None |
| 53 | visa-doc-translate | ECC | `skills/visa-doc-translate/SKILL.md` | Visa document translation and preparation | Not specified | — | None |
| 54 | frontend-slides | ECC | `skills/frontend-slides/SKILL.md` | Presentation/slide generation from frontend code | Not specified | — | None |

### Experimental/Agentic

| # | Skill Name | Source Repo | Source Path | What It Does (1 sentence) | Triggering Conditions | Line Count | Dependencies |
|---|-----------|-------------|-------------|--------------------------|----------------------|------------|-------------|
| 55 | autonomous-loops | ECC | `skills/autonomous-loops/SKILL.md` | Autonomous agent execution loops without human checkpoints | Not specified | — | None |
| 56 | continuous-agent-loop | ECC | `skills/continuous-agent-loop/SKILL.md` | Persistent agent loop that maintains state across iterations | Not specified | — | None |
| 57 | enterprise-agent-ops | ECC | `skills/enterprise-agent-ops/SKILL.md` | Enterprise-scale agent operations patterns | Not specified | — | None |
| 58 | agent-payment-x402 | ECC | `skills/agent-payment-x402/SKILL.md` | Agent-to-agent payment via x402 protocol | Not specified | — | None |
| 59 | liquid-glass-design | ECC | `skills/liquid-glass-design/SKILL.md` | Liquid glass UI design patterns | Not specified | — | None |
| 60 | santa-method | ECC | `skills/santa-method/SKILL.md` | Santa method for structured problem decomposition | Not specified | — | None |

### Niche/Industry

| # | Skill Name | Source Repo | Source Path | What It Does (1 sentence) | Triggering Conditions | Line Count | Dependencies |
|---|-----------|-------------|-------------|--------------------------|----------------------|------------|-------------|
| 61 | healthcare-phi-compliance | ECC | `skills/healthcare-phi-compliance/SKILL.md` | HIPAA/PHI compliance patterns for healthcare data | Not specified | — | None |
| 62 | carrier-relationship-management | ECC | `skills/carrier-relationship-management/SKILL.md` | Logistics carrier relationship and rate management | Not specified | — | None |
| 63 | customs-* | ECC | `skills/customs-*/SKILL.md` | Customs/trade compliance workflows (multiple skills) | Not specified | — | None |
| 64 | energy-* | ECC | `skills/energy-*/SKILL.md` | Energy sector operational patterns (multiple skills) | Not specified | — | None |
| 65 | logistics-* | ECC | `skills/logistics-*/SKILL.md` | Logistics and supply chain patterns (multiple skills) | Not specified | — | None |
| 66 | inventory-* | ECC | `skills/inventory-*/SKILL.md` | Inventory management patterns (multiple skills) | Not specified | — | None |
| 67 | production-scheduling | ECC | `skills/production-scheduling/SKILL.md` | Manufacturing production scheduling workflows | Not specified | — | None |
| 68 | quality-nonconformance | ECC | `skills/quality-nonconformance/SKILL.md` | Quality control nonconformance tracking and resolution | Not specified | — | None |
| 69 | returns-reverse-logistics | ECC | `skills/returns-reverse-logistics/SKILL.md` | Returns processing and reverse logistics workflows | Not specified | — | None |

### GSD Workflow Skills (slash commands, not SKILL.md files)

| # | Skill Name | Source Repo | Source Path | What It Does (1 sentence) | Triggering Conditions | Line Count | Dependencies |
|---|-----------|-------------|-------------|--------------------------|----------------------|------------|-------------|
| 70 | /gsd:quick | GSD | `get-shit-done/workflows/quick.md` | Lightweight planned execution: 10-step process with optional discuss/research/full flags, single plan with 1-3 tasks | Manual invocation with flags | — | Active project (ROADMAP.md) |
| 71 | /gsd:fast | GSD | `get-shit-done/workflows/fast.md` | Inline trivial tasks: ≤3 file edits, ≤1 minute, no subagent, no PLAN.md | Manual invocation | — | None |
| 72 | /gsd:do | GSD | `get-shit-done/workflows/do.md` | Intent-based dispatcher: takes freeform text, routes to best GSD command | Manual invocation | — | All GSD workflows |

**Total: 72 skills cataloged across 4 repos**
...
| ECC pytorch-* agents | PyTorch | Not applicable |
