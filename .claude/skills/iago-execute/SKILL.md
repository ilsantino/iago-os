...
The Workflow also forwards it into the @claude tag comment and the durable summary
(`.iago/summaries/{plan}.md` + `pipeline-runs.ndjson`). Surface the list alongside the honesty
signals below: routed-out-of-the-fix-loop is not the same as resolved.
